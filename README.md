...
127.0.0.1       mongo3
```
## you can run all the below scripts either by manually or run setup.sh file in terminal it will setup environment and no need to run other script. Execute setup.sh script using below command:
